...
//  IFACE_SPI_TIMEOUT
//  IFACE_SPI_RX_RING_OVERWRITE  0/1
...
static inline bool spi_wait_tx_complete(void) {
  return reg_wait((__IO uint32_t*)&SPI1->STATR, SPI_STATR_TXE, true, IFACE_SPI_TIMEOUT); }

static inline bool spi_wait_rx_available(void) {
  return reg_wait((__IO uint32_t*)&SPI1->STATR, SPI_STATR_RXNE, true, IFACE_SPI_TIMEOUT); }

static inline bool spi_wait_not_busy(void) {
  return reg_wait((__IO uint32_t*)&SPI1->STATR, SPI_STATR_BSY, false, IFACE_SPI_TIMEOUT); }
